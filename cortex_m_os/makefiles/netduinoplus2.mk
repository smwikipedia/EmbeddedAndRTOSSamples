...
QEMU_CMD_DEBUG = $(QEMU_ARM) -s -S -M $(QEMU_BOARD_NAME) -cpu cortex-m4 -serial telnet:127.0.0.1:1124,server -device loader,file=$(KERNEL_BIN)
QEMU_CMD_RUN = $(QEMU_ARM) -s -M $(QEMU_BOARD_NAME) -cpu cortex-m4 -serial telnet:127.0.0.1:1124,server -device loader,file=$(KERNEL_BIN)
