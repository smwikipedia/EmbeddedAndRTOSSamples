...
PERIPHERAL_NVIC_DIR = $(PERIPHERAL_DIR)/nvic/$(CMSIS_MCU)
...
OBJ_KERNEL_NVIC = $(BUILD_DIR)/nvic.o
$(OBJ_KERNEL_NVIC) : $(PERIPHERAL_NVIC_DIR)/$(QEMU_BOARD_NAME).c
	echo "build kernel nvic setup"
	$(GCC) $(GCC_FLAGS) $(PERIPHERAL_NVIC_DIR)/$(QEMU_BOARD_NAME).c -o $(OBJ_KERNEL_NVIC)
...
OS_DPENDENCIES = $(OBJ_STARTUP_MCU) $(OBJ_KERNEL_MAIN) $(OBJ_KERNEL_SYSTEMINIT) $(OBJ_KERNEL_NVIC) $(OBJ_USART)
