...
struct uart_pl011_dev_cfg_t {
    ...
    uint32_t def_baudrate;                        /*!< Default baudrate */
    enum uart_pl011_wlen_t def_wlen;       /*!< Default word length */
    enum uart_pl011_parity_t def_parity;        /*!< Default parity */
    enum uart_pl011_stopbit_t def_stopbit;   /*!< Default stop bits */
};
...
struct uart_pl011_dev_t {
    struct uart_pl011_dev_cfg_t* cfg;
                                              /*!< UART PL011 configuration */
    struct uart_pl011_dev_data_t* data;
                                              /*!< UART PL011 data */
};
